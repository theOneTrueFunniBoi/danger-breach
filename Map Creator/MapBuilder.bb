...
;Select Rand(0,7)
;	Case 0
;		SetPanelImage(panelloading,"..\Loadingscreens\178.jpg")
;	Case 1
;		SetPanelImage(panelloading,"..\Loadingscreens\268.jpg")
;	Case 2
;		SetPanelImage(panelloading,"..\Loadingscreens\294.jpg")
;	Case 3
;		SetPanelImage(panelloading,"Assets\map_logo.jpg")
;	Case 4
;		SetPanelImage(panelloading,"..\Loadingscreens\foundationlogo.jpg")
;	Case 5
;		SetPanelImage(panelloading,"..\Loadingscreens\008.jpg")
;	Case 6
;		SetPanelImage(panelloading,"..\Loadingscreens\939.jpg")
;	Case 7
;		SetPanelImage(panelloading,"..\Loadingscreens\066.jpg")
;End Select

SetPanelImage(panelloading,"Assets\map_logo.jpg")

SetStatusText(Loadingwindow, "-----INIT-----")

; create a window to put the toolbar in
WinHandle=CreateWindow("SCP-DB Map Builder "+VersionNumber,GraphicsWidth()/2-ResWidth/2, GraphicsHeight()/2-ResHeight/2,ResWidth,ResHeight,0, 13) 
...
SetStatusText(Loadingwindow, "Map Builder is Starting, Please Wait...")
...
Next
;------------------------------------------------------------------------------Facility
Global OptionFile$ = SystemProperty("tempdir")+"..\"+"DangerBreach\options.ini"
Global MapWidth = GetINIInt(OptionFile, "options", "map width")
Global MapHeight = GetINIInt(OptionFile, "options", "map height")
...
SetStatusText(Loadingwindow, "Create File Menu")
...
SetStatusText(Loadingwindow, "Create Options Menu")
...
SetStatusText(Loadingwindow, "Load Options")
...
SetStatusText(Loadingwindow, "INIT Map Renderer")
ExecFile("renderMap3d.exe")

Repeat
	vwprt = api_FindWindow("Blitz Runtime Class" , "MapBuilder 3D Renderer");User32.dll
	ShowGadget Loadingwindow
Until vwprt <> 0
SetStatusText(Loadingwindow, "Create 3D scene")
