...
DebugLog("Attempted to load - "+Door_LCZ)
HideEntity Door_LCZ
Global Door_HCZ_1 = LoadMesh("GFX\Map\heavydoor1.x")
DebugLog("Attempted to load - "+Door_HCZ_1)
HideEntity Door_HCZ_1
Global Door_HCZ_2 = LoadMesh("GFX\Map\heavydoor2.x")
DebugLog("Attempted to load - "+Door_HCZ_2)
HideEntity Door_HCZ_2
Global Door_EZ = LoadMesh("GFX\Map\Door02.b3d")
DebugLog("Attempted to load - "+Door_EZ)
HideEntity Door_EZ
Global Door_Frame = LoadMesh("GFX\Map\DoorFrame.x")
DebugLog("Attempted to load - "+Door_Frame)
HideEntity Door_Frame
Global Door_Button = LoadMesh("GFX\Map\Button.x")
DebugLog("Attempted to load - "+Door_Button)
...
DebugLog("Attempted to load - "+FileLocation)
