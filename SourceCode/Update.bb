...
Global UserAgent$ = "SCPDB"	; What ever you'd like to name your application
...
Function CheckForUpdates()
	...
	Cls
	Color 255,255,255
	Text LauncherWidth/2,LauncherHeight/2,"Checking for updates...",True,True
	Flip
	...
	If latest<>VersionNumber And latest<>"" Then ;a new version is available!
		...
		UpdaterBG = LoadImage_Strict("GFX\menu\launcherShared.jpg")
