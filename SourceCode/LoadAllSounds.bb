Function LoadAllSounds()
	...
	;Local radioTrackCount% = 0
	
	; NUM RADIO TRACKS MUST NEVER EXCEED 20
	
	radioStringGlobal = ""
	
	Repeat
		If FileSize("SFX\Radio\scpradio"+totalRadioTracks+".ogg")=0
			Exit
		Else
			RadioSFX(2,totalRadioTracks) = LoadSound_Strict("SFX\Radio\scpradio"+totalRadioTracks+".ogg")
			totalRadioTracks = totalRadioTracks + 1
		End If
	Until totalRadioTracks = 20
