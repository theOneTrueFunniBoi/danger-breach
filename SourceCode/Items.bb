...
Function InitItemTemplates()
	...
	it = CreateItemTemplate("Document SCP-173 FOR D-CLASS PERSONNEL", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "GFX\items\doc173d.jpg", 0.003) : it\sound = 0
	
	;2.3.2 stuff
	
	it = CreateItemTemplate("Document SCP-3312", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "GFX\items\doc3312.png", 0.003) : it\sound = 0
	
	it = CreateItemTemplate("Class D Orientation Leaflet - Page 1/2", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "GFX\items\docOrientation.png", 0.003) : it\sound = 0	
	
	it = CreateItemTemplate("Class D Orientation Leaflet - Page 2/2", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "GFX\items\docOrientation2.png", 0.003) : it\sound = 0
	
	it = CreateItemTemplate("Hastily Scribbled Note", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "GFX\items\doc3312-1.jpg", 0.003) : it\sound = 0
	
	;this is so fucking stupid, for some reason it doesn't clear the overridden model texture,
	;so every other item from this point onward (ending at the Next one to override it's model texture) will use the doc3312-1 texture
	;future me pls fix
	;it = CreateItemTemplate("Hastily Scribbled Note", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "GFX\items\doc3312-1.jpg", 0.003, "GFX\items\doc3312-1.jpg") : it\sound = 0
	
	;2.3.1 stuff
	
	it = CreateItemTemplate("Irish Cap", "scp268", "GFX\items\hat.b3d", "GFX\items\INVscp268.jpg", "", 0.1) : it\sound = 0
	
	CreateItemTemplate("Janitor Key Card", "key0",  "GFX\items\keycard.x", "GFX\items\INVkey0.png", "", 0.0004,"GFX\items\keycard0.png")
	
	it = CreateItemTemplate("Skeleton Key", "key7", "GFX\items\005.b3d", "GFX\items\INV005.jpg", "", 0.0004)
	it\sound = 3
	
	;2.3.0 stuff
	
	it = CreateItemTemplate("Scribbled Document", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "GFX\items\docScribble.png", 0.003) : it\sound = 0
	
	it = CreateItemTemplate("Scribbled Sticky Note", "paper", "GFX\items\note.x", "GFX\items\INVnote2.jpg", "GFX\items\note2ccont.jpg", 0.0025) : it\sound = 0
	
	it = CreateItemTemplate("Betamax Tape", "1981", "GFX\items\betamax.b3d", "GFX\items\INVscp1981.jpg", "", 0.01)
	
	it = CreateItemTemplate("Scramble Goggles", "scrabble", "GFX\items\NVG.b3d", "GFX\items\INVscrabble.jpg", "", 0.02) : it\sound = 2
	
	it = CreateItemTemplate("Note From Dr. Hoth", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "GFX\items\docKey5.png", 0.003) : it\sound = 0
	
	;2.2.9 and older stuff
	...
	it = CreateItemTemplate("Ultra Night Vision Goggles", "supernv", "GFX\items\NVG.b3d", "GFX\items\INVsupernightvision.jpg", "", 0.02) : it\sound = 2
	it = CreateItemTemplate("Night Vision Goggles", "nvgoggles", "GFX\items\NVG.b3d", "GFX\items\INVnightvision.jpg", "", 0.02) : it\sound = 2
	it = CreateItemTemplate("Super Night Vision Goggles", "finenvgoggles", "GFX\items\NVG.b3d", "GFX\items\INVveryfinenightvision.jpg", "", 0.02) : it\sound = 2
