...
Function UpdateSky(obj%,SKYCAM%)
	PositionEntity obj, EntityX(SKYCAM),EntityY(SKYCAM),EntityZ(SKYCAM), True
End Function

;Function UpdateMenuSky(obj%)
;	PositionEntity obj, EntityX(MenuCam),EntityY(MenuCam),EntityZ(MenuCam), True
;End Function
